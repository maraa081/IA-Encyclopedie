...
- **Critère d'auto-validation** : Savoir configurer les paramètres de génération (repetition penalty, température, top_k, top_p).
...
- **Objectifs** : Concevoir un pipeline de Retrieval-Augmented Génération complet : découpage (chunking), indexation vectorielle, recherche et génération.
...
- **Papiers fondateurs indispensables** :
  ...
  - *Retrieval-Augmented Génération for Knowledge-Intensive NLP Tasks* (Lewis et al., 2020)
- **Blogs et actualités** :
